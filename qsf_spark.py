...
def qsf(query: str):
    ...
    ctx = snowflake.connector.connect(
        user="XXXXXXXXXXXXXXXX",  # Replace with your email
        account='XXXXXXXXXXXXXXXX.privatelink',
        authenticator='oauth',
...
# Example usage
#q_create = '''
#drop table XXXXXXXX.XXXXXXXX.AZ_REPORT_AUDIT_LOG;
#'''
...
#wsf_spark(df, "XXXXXXXXXXXXXXXX", "example_table")
...
# create_table_from_df_spark(df, "XXXXXXXXXXXXXXXX", "example_table", client_id, client_secret, refresh_token, token_endpoint)
